...
export const BUILTIN_PLUGINS: PluginDescriptor[] = [
  { id: "x", name: "X", vendor: "X Corp", summary: "Post, reply, and read your timeline.", authentication: "preview", prefersDarkTile: false, logo: { onDark: "plugin-x-onDark", onLight: "plugin-x-onLight" }, fallbackIcon: null },
  ...
  { id: "vidiq", name: "vidIQ", vendor: "vidIQ", summary: "Research keywords and read your channel stats.", authentication: "apiKey", prefersDarkTile: false, logo: { file: "plugin-vidiq" }, fallbackIcon: null },
  ...
  { id: "youtube", name: "YouTube", vendor: "Google", summary: "Upload videos and read channel comments.", authentication: "oauthMCP", prefersDarkTile: false, logo: { file: "plugin-youtube" }, fallbackIcon: null },
  ...
  { id: "vercel", name: "Vercel", vendor: "Vercel", summary: "Deploy previews, read build logs, and manage project domains.", authentication: "apiKey", prefersDarkTile: false, logo: { onDark: "plugin-vercel-onDark", onLight: "plugin-vercel-onLight" }, fallbackIcon: null },
  ...
  { id: "unreal", name: "Unreal Engine", vendor: "Epic Games", summary: "Drive running Unreal Editor instances via official local MCP.", authentication: "localMCP", prefersDarkTile: false, logo: { onDark: "plugin-unreal-onDark", onLight: "plugin-unreal-onLight" }, fallbackIcon: null },
  { id: "unity", name: "Unity", vendor: "Unity Technologies", summary: "Inspect live scenes and edit GameObject components via local MCP.", authentication: "localMCP", prefersDarkTile: false, logo: { onDark: "plugin-unity-onDark", onLight: "plugin-unity-onLight" }, fallbackIcon: null }
];
                ...
                <span className="plugin-card__head">
                  ...
                  >
                    <img
                      src={
                        "file" in plugin.logo
                          ? `/assets/logos/${plugin.logo.file}.png`
                          : `/assets/logos/${plugin.logo.onDark}.png`
                      }
                      alt=""
